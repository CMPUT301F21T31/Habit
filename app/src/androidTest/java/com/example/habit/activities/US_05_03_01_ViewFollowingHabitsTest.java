...
public class US_05_03_01_ViewFollowingHabitsTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void uS_05_03_01_ViewFollowingHabitsTest() {
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.emailInput),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("testui@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.passwordInput),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("testpwd"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.title_with_name), withText("UI Test 2's Habits"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("UI Test 2's Habits")));
    }

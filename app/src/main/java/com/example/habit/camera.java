...
public class camera extends AppCompatActivity {
    ...
    private void openCamera() {
        try {
            ...
            ActivityCompat.requestPermissions(camera.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);
